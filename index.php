...
<head>
	<meta charset="utf-8">
	<title>Instant Danse</title>
	 <link rel="stylesheet" href="assets/css/style.css">
</head>
<body>
	<h1 style="color: white">Instant Danse</h1>
...
$model = new Model();
$objPDOStatement = $model->trouverLigneChamp("event", ["id"=>1]);
if ($ligne = $objPDOStatement->fetch()):

?>

 <time datetime="2015-08-02" class="hidden" style="overflow:hidden">
  <a href="http://thenewcode.com/1057/SVG-Patterns-of-Japan"><img src="<?php echo $ligne['img'] ?>" alt="SVG Patterns of Japan">
    
   <span
   class="caldate">02</span><span class="title">
   <?php echo $ligne['type'] ?></span></a>
 </time>
